    ...
    <div className="h-full flex flex-col fade-in">
      <header className="px-6 py-4 border-b border-[#1E293B] shrink-0 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-[#64748B]/20 rounded-lg">
            <LogIn className="w-5 h-5 text-[#94A3B8]" />
          </div>
          <div>
      ...
      <div className="p-6 shrink-0 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4 flex-1">
          <input type="text" placeholder="登录账号" className="bg-[#111622] border border-[#1E293B] rounded-lg px-4 py-2 text-sm text-[#94A3B8] focus:border-white outline-none" />
          <input type="text" placeholder="用户姓名" className="bg-[#111622] border border-[#1E293B] rounded-lg px-4 py-2 text-sm text-[#94A3B8] focus:border-white outline-none" />
          ...
          <input type="text" placeholder="登录时间范围" className="bg-[#111622] border border-[#1E293B] rounded-lg px-4 py-2 text-sm text-[#94A3B8] focus:border-white outline-none" />
        </div>
      </div>
