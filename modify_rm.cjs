              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-xs">
                      <div><span className="text-[#94A3B8]">保单号：</span><div className="text-white mt-1">INS202405001</div></div>
                      <div><span className="text-[#94A3B8]">承保公司：</span><div className="text-white mt-1">太平洋财产保险</div></div>
                      <div><span className="text-[#94A3B8]">保障期限：</span><div className="text-white mt-1">2024.01 - 2025.01</div></div>
                      <div><span className="text-[#94A3B8]">业务员：</span><div className="text-white mt-1">孙七 13500005555</div></div>
                      <div><span className="text-[#94A3B8]">理赔专员：</span><div className="text-white mt-1">周八 13400006666</div></div>
                    </div>
                 </div>
                 <div className="space-y-4">
                    ...
                    <table className="w-full text-left bg-[#0F172A] border border-[#1E293B] rounded">
                      ...
                      <tbody className="text-xs text-white divide-y divide-[#1E293B]">
                        <tr><td className="px-3 py-2">一级赔付</td><td className="px-3 py-2 font-mono">142.04~144.04</td><td className="px-3 py-2 text-orange-400 font-mono">400,000</td></tr>
                        <tr><td className="px-3 py-2">二级赔付</td><td className="px-3 py-2 font-mono">144.04~147.71</td><td className="px-3 py-2 text-orange-400 font-mono">2,000,000</td></tr>
                        <tr><td className="px-3 py-2">三级赔付</td><td className="px-3 py-2 font-mono">147.71~--</td><td className="px-3 py-2 text-orange-400 font-mono">30,000,000</td></tr>
                      </tbody>
                    </table>
                 </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                 {wlTab === 'add' ? (
                   <div className="space-y-4">
                     ...
                     <div className="space-y-1.5"><label className="text-xs text-[#94A3B8]">采集时间 (支持选择全天或特定时段)</label><input type="datetime-local" className="w-full bg-[#0F172A] border border-[#1E293B] rounded px-3 py-2 text-xs text-white outline-none focus:border-tech-cyan" /></div>
